export default function ButtonRectangle({
  ...
  return (
    <div className="group p-[2px] rounded-lg bg-dark-secondary cursor-pointer hover:bg-gradient-to-r  hover:from-violet-700  hover:to-blue-900 hover:dark:bg-gradient-to-r  hover:dark:from-yellow-400  hover:dark:to-orange-500">
