export default function ButtonRectangle({
  ...
  return (
    <div className="select-none	group p-[2px] rounded-lg cursor-pointer bg-white dark:bg-dark-secondary hover:bg-gradient-to-r  hover:from-violet-700  hover:to-blue-900 dark:hover:bg-gradient-to-r  dark:hover:from-yellow-400  dark:hover:to-orange-500">
      <div className="h-[36px] p-[12px] rounded-md flex justify-center items-center font-bold text-md bg-white dark:bg-dark-tertiary">
